//
//  SFSocketClientShell.h
//  SifliOCore
//
//  Created by congqiang on 2026/5/25.
//
...
@interface SFSocketClientShell :  NSObject<SFTransmissionShell,SFModuleDelegate>
...
@property (nonatomic,copy,nullable) NSString *targetIP;
