...
#import <SifliOCore/SSZipCommon.h>
...
@protocol SFSSZipArchiveDelegate;

@interface SFSSZipArchive : NSObject
...
+ (BOOL)unzipFileAtPath:(NSString *)path toDestination:(NSString *)destination delegate:(nullable id<SFSSZipArchiveDelegate>)delegate;
...
+ (BOOL)unzipFileAtPath:(NSString *)path
          toDestination:(NSString *)destination
              overwrite:(BOOL)overwrite
               password:(nullable NSString *)password
                  error:(NSError * *)error
               delegate:(nullable id<SFSSZipArchiveDelegate>)delegate NS_REFINED_FOR_SWIFT;
...
+ (BOOL)unzipFileAtPath:(NSString *)path
     ...
     preserveAttributes:(BOOL)preserveAttributes
              overwrite:(BOOL)overwrite
               password:(nullable NSString *)password
                  error:(NSError * *)error
               delegate:(nullable id<SFSSZipArchiveDelegate>)delegate;
...
@protocol SFSSZipArchiveDelegate <NSObject>
